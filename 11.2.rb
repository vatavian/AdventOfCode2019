# Advent of Code 2019 Day 11 Part Two https://adventofcode.com/2019/day/11#part2
...
# For part 2, start on a white square and print out the resulting paint job
class Integer
  def split_digits
    return [0] if zero?
    res = []
...
class RobotPainter
  ...
  def set_defaults
    ...
    @panel_color[@position] = 1 # For part 2, start on a white square
  ...
  def print_panels
    ...
    max_x = -9999
    max_y = -9999
    puts "#{@panel_color.length} panels have been painted"
    @panel_color.each_key do |coords|
