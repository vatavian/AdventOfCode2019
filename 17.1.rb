# Advent of Code 2019 Day 17 Part One https://adventofcode.com/2019/day/17
# Set and Forget: Intcode-driven robot with a vacuum
class Integer
  def split_digits
    return [0] if zero?
    res = []
...
session = Board.new
session.run(program, first_moves)
session.compute_alignment_parameters
#session.print_tiles
